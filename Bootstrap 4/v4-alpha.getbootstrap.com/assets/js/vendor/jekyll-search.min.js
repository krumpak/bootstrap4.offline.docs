...
function locale(){
  ...
  var html = "<a name='totop' id='totop'></a><a id='totop-btn' href='#totop' class='btn btn-info'>top</a>";
      html += "<div id='c-banner'>";
      html += "<a href='/Bootstrap 4/v4-alpha.getbootstrap.com/getting-started/introduction/index.html'>Bootstrap 4 <small>[Offline]</small></a>";
      html += "<a href='http://v4-alpha.getbootstrap.com/getting-started/introduction/' target='_blank'>Bootstrap 4 <small>[Online]</small></a>";
      html += "<a href='http://bootstrap3.offline.docs/' target='_blank'>Bootstrap 3 <small>[Offline]</small></a>";
